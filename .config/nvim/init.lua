...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- See `:help telescope.builtin` a
      local builtin = require 'telescope.builtin'
      vim.keymap.set('n', '<leader>sc', builtin.command_history, { desc = '[S]earch [C]ommands History' })
      vim.keymap.set('n', '<leader>sd', builtin.git_status, { desc = '[S]earch [C]hanged Files' })
      ...
      vim.keymap.set('n', '<leader>sdi', builtin.diagnostics, { desc = '[S]earch [D]iagnostics' })
